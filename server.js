        ...
        if (result.rows.length > 0) {
            ...
            if (match) {
                ...
                req.session.save(err => {
                    ...
                    // Send success JSON response ONLY after session is saved
...
// ===========================================
app.get('/logout', (req, res) => { /* ... code remains the same ... */ });

// --- Auth Middleware ---
const isAuthenticated = (req, res, next) => { /* ... code remains the same ... */ };
